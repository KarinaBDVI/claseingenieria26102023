...
$campos = [
    ...
    'titulo_otorgado' => 'Título que Entrega',
    'duracion' => 'Duración',
    'modalidad' => 'Modalidad',
    'carga_horaria' => 'Carga Horaria',
    'estado_carrera' => 'Estado de Carrera'
]; */
// Obtener los datos del formulario
    if ($_SERVER['REQUEST_METHOD'] === 'POST' ) {
        ...
        $nombre_carrera_n = $_POST['nombre_carrera'];
        $titulo_otorgado_n = $_POST['titulo_otorgado'];
        $duracion_n = $_POST['duracion'];
        $modalidad_n = $_POST['modalidad'];
        $carga_horaria_n = $_POST['carga_horaria'];
                ...
                <div>
                    <form class="row g-3 mt-4 ms-4 me-4" method="post" action="ingresarcarrera.php" >
                        <div class="col-md-6 position-relative">
                            ...
                            <input class="form-control" type="text" name="cod_carrera" id="cod_carrera">
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input class="form-control" type="text" name="nro_resolucion" id="nro_resolucion">
                        </div>
                        <div class="col-md-6 position-relative">
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input class="form-control" type="text" name="titulo_otorgado" id="titulo_otorgado" >
                        </div>
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input class="form-control" type="number" name="duracion" id="duracion" min="0"  >
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input class="form-control" type="number" name="carga_horaria" id="carga_horaria" min="0" >
                       ...
                       <!--  <div class="col-md-6 offset-1 mb-5">
                         ...
                         <div class="col-md-3 offset-2 ">
                            <div class="d-flex mb-5 gap-2 justify-content-between align-content-center">
                                ...
                                <a class="" href="tablalistadocarreras.php"><button type="button" class="btn btn-primary menu-icon border-0 px-4 text-wrap">Volver</button></a>                     
                            </div>
                        </div>
                    </form>
